            ...
            <div class="modal-body">
                <form method="POST" action="" id="formManageUsers">
                    ...
                    <div class="md-form">
                        ...
                        <input type="text" name="name" value="{{$userInfo != null? $userInfo->fullname : ''}}" id="defaultForm-name" class="form-control">
                    ...
                    <div class="md-form">
                        ...
                        <input type="number" name="phone" value="{{$userInfo != null? $userInfo->phone : ''}}" id="defaultForm-digits" class="form-control">
